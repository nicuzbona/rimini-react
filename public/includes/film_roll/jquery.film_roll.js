...
(function($) {
  this.FilmRoll = (function() {
    ...
    FilmRoll.prototype.configure = function() {
      ...
      this.slider_container = this.options.container;
      ...
      if (this.options.vertical_center) {
        this.shuttle.addClass('vertical_center');
          ...
          // ********************************************************
          if(this.options.firstSlider){
            this.shouldAddId = true;
          }else{
            this.shouldAddId = false;
          }
          // ********************************************************
      ...
      // ********************************************************
      this.first_slider_child = this.div.find('.film_roll_child');
      if(this.shouldAddId || true){
        this.first_slider_child.attr('id', 'slider_child');
      }
      // ********************************************************
      ...
      if (this.options.prev !== false) {
        if (this.options.prev && this.options.next) {
          ...
          this.wrapper.append('<a class="film_roll_prev" id="prev_button" href="#"> </a>');
      ...
      if (this.options.next !== false) {
        if (this.options.next) {
          ...
          this.wrapper.append('<a class="film_roll_next" id="next_button" href="#"> </a>');
